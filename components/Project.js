...
const Project = () => {
    const items = [
        {
            ...
            description: "A demo blog platform built with Next.js 15, featuring dynamic routing, Markdown rendering (via remark, rehype, unified), and styled with shadcn/ui. Includes Type.js for typing effects. A learning-focused project showcasing modern blog functionality and content processing.",
            liveLink: "https://markdown-blog-topaz.vercel.app/",
            githubLink: "https://github.com/KhurramRaja35/Markdown-Blog",
    ...
    return (
        <section id='work' className=' flex flex-col gap-6 py-10  md:py-15 lg:py-20'>
            ...
            <div className={`${styles.carouselContainer} carousel mx-5`}>
                <Swiper
                    slidesPerView={4}
                    spaceBetween={30}
                    loop={true}
